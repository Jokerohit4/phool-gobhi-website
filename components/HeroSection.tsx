        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div className="space-y-7 min-w-0" variants={container} initial="hidden" animate="visible">
            <motion.div variants={item} className="sticker inline-flex px-5 py-2 bg-cream-100 dark:bg-gray-900">
              <span className="font-bold text-sm text-gray-900 dark:text-white">🥦 Booking Open Now</span>
            </motion.div>
            ...
            <motion.div variants={item} className="flex flex-col sm:flex-row gap-4">
              <motion.span whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.96 }}>
                <Link href="/gyms" className="btn-primary text-center block">
                  Find a Gym 🥦
                </Link>
              </motion.span>
              {!sessionLoading && (
                <motion.span whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.96 }}>
                  <Link href={user ? '/account/bookings' : '/login'} className="btn-secondary text-center block">
          ...
          >
            ...
            >
              ...
              <h3 className="text-2xl font-bold mb-3">Book in Minutes</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">
                Gobhi&apos;s already stretched. Pick a gym, pick a slot, pay for just that session — no forms, no queue, no waiting for &quot;launch day.&quot;
              </p>
              ...
              <motion.span
                ...
                className="block"
              >
                <Link href="/gyms" className="btn-primary w-full text-center block">
                  Browse Gyms Now 🥦
                </Link>
              </motion.span>
            </motion.div>
