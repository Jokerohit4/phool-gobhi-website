...
export async function POST(req: Request) {
  ...
  try {
    // Same HMAC-verify-then-credit shape as /api/wallet/verify, just fulfils
    // a subscription row instead of a wallet credit.
    const data = await authedGatewayFetch('/api/wallet/subscriptions/verify', {
      method: 'POST',
